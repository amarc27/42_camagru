...
{
  var gallery = document.getElementById("feed")
...
(function() {
  ...
  function takepicture() {
    ...
    else 
    {
      ...
      ajax_form("webcam", data, "model/picturesModel.php");
  ...
  var layersCont = document.getElementById('sticker_frame').getElementsByTagName('img');
